...
//   const navigate = useNavigate(); //allows component to navigate between different pages
...
//             Search Results Page
//           </Typography>
//           <Button className="myButton" onClick={() => navigate('/searchBy')}>Search</Button>
//           <Button className="myButton" onClick={() => navigate('/exhibitmain')}>Exhibit</Button>
//         </Toolbar>
//       </AppBar>
//     </Root>
//   );
